...
public class PieChart implements Drawable, Legendable {
    ...
    static final float FIRST_SECTOR_OFFSET = -90;
    ...
    public PieChart(PlotSheet plotSheet, double[] values, ColorWrap[] colors) {
    ...
    private void checkArguments(PlotSheet plotSheet, double[] values, ColorWrap[] colors) {
        if (plotSheet == null) {
