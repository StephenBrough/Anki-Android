...
class DatabaseErrorDialog : AsyncDialogFragment() {
    ...
    override val notificationMessage: String = message

    override val notificationTitle: String = resources.getString(R.string.answering_error_title)
        ...
        when (dialogType) {
            ...
            DIALOG_DB_ERROR -> {
                ...
                val dialog = builder
                        ...
                        .show()
                dialog.customView!!.findViewById<View>(R.id.buttonDefaultNegative).isEnabled = (activity as DeckPicker).hasErrorFiles()
                return dialog
            }
