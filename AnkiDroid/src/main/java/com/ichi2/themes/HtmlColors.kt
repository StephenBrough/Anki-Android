...
object HtmlColors {
    ...
    fun nameToHex(name: String): String {
        ...
        return if (sColorsMap!!.containsKey(name)) {
            sColorsMap!![name]!!
        } else name
    }
    ...
    fun invertColors(text: String): String {
        ...
        while (m1.find()) {
            ...
            var color = HtmlColors.nameToHex(m1.group(2))
            var m2: Matcher? = null
            try {
