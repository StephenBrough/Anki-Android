...
class AnkiDroidWidgetSmall : AppWidgetProvider() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        if (intent.action!!.contentEquals("com.sec.android.widgetapp.APPWIDGET_RESIZE")) {
            CompatHelper.getCompat().updateWidgetDimensions(context, RemoteViews(context.packageName, R.layout.widget_small), AnkiDroidWidgetSmall::class.java)
        }
    ...
    class UpdateService : Service() {
        ...
        private fun buildUpdate(context: Context, updateDueDecksNow: Boolean): RemoteViews {
            ...
            CompatHelper.getCompat().updateWidgetDimensions(context, updateViews, AnkiDroidWidgetSmall::class.java)
