...
package com.ichi2.anki.studyoptions;
...
public class StudyOptionsFragment extends Fragment implements Toolbar.OnMenuItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mToolbar = mStudyOptionsView.findViewById(R.id.studyOptionsToolbar);
    ...
    private void initAllContentViews() {
        ...
        mTextDeckName = mStudyOptionsView.findViewById(R.id.studyoptions_deck_name);
        mTextDeckDescription = mStudyOptionsView.findViewById(R.id.studyoptions_deck_description);
        // make links clickable
        mTextDeckDescription.setMovementMethod(LinkMovementMethod.getInstance());
        mButtonStart = mStudyOptionsView.findViewById(R.id.studyoptions_start);
        mTextCongratsMessage = mStudyOptionsView.findViewById(R.id.studyoptions_congrats_message);
        // Code common to both fragmented and non-fragmented view
        mTextTodayNew = mStudyOptionsView.findViewById(R.id.studyoptions_new);
        mTextTodayLrn = mStudyOptionsView.findViewById(R.id.studyoptions_lrn);
        mTextTodayRev = mStudyOptionsView.findViewById(R.id.studyoptions_rev);
        mTextNewTotal = mStudyOptionsView.findViewById(R.id.studyoptions_total_new);
        mTextTotal = mStudyOptionsView.findViewById(R.id.studyoptions_total);
        mTextETA = mStudyOptionsView.findViewById(R.id.studyoptions_eta);
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_rename:
                ((DeckPickerActivity) getActivity()).renameDeckDialog(getCol().getDecks().selected());
                return true;
            case R.id.action_delete:
                ((DeckPickerActivity) getActivity()).confirmDeckDeletion(getCol().getDecks().selected());
                return true;
            case R.id.action_export:
                ((DeckPickerActivity) getActivity()).exportDeck(getCol().getDecks().selected());
                return true;
            default:
                return false;
        }
    ...
    public void configureToolbar() {
        ...
        if (!mFragmented) {
            ...
            mToolbar.setNavigationOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ((AnkiActivity) getActivity()).finish();
                }
            });
        }
    }
