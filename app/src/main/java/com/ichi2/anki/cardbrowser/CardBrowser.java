...
public class CardBrowser extends NavigationDrawerActivity implements
            ...
            switch (which) {
                ...
                case CardBrowserContextMenu.CONTEXT_MENU_SUSPEND:
                    ...
                    DeckTask.launchDeckTask(
                            ...
                            mSuspendCardHandler,
                            new TaskData(new Object[]{card, Collection.DismissType.SUSPEND_CARD}));
                    return;
                            ...
                            .onPositive(new MaterialDialog.SingleButtonCallback() {
                                ...
                                public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                                    ...
                                    DeckTask.launchDeckTask(DeckTask.TASK_TYPE_DISMISS,
                                            mDeleteNoteHandler,
                                            new TaskData(new Object[]{card, Collection.DismissType.DELETE_NOTE}));
                                }
                            })
                            .build().show();
                    return;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == DeckPickerActivity.Companion.getRESULT_DB_ERROR()) {
            closeCardBrowser(DeckPickerActivity.Companion.getRESULT_DB_ERROR());
        }
    ...
    private void searchCards() {
        ...
        if (colIsOpen() && mCardsAdapter!= null) {
            ...
            DeckTask.launchDeckTask(DeckTask.TASK_TYPE_SEARCH_CARDS, mSearchCardsHandler, new TaskData(
