...
package com.ichi2.anki.junkdrawer.provider;
...
public class CardContentProvider extends ContentProvider {
    ...
    private boolean shouldEnforceQueryOrInsertSecurity() {
        return CompatHelper.Companion.isMarshmallow() || knownRogueClient();
    }
    ...
    private boolean shouldEnforceUpdateSecurity(Uri uri) {
        ...
        return CompatHelper.Companion.isMarshmallow() || !WHITELIST.contains(sUriMatcher.match(uri)) || knownRogueClient();
    }
