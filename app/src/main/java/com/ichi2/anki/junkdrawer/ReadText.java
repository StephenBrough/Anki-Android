...
package com.ichi2.anki.junkdrawer;
    ...
    public static void initializeTts(Context context) {
        ...
        mTts = new TextToSpeech(context, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                ...
                CompatHelper.Companion.getCompat().setTtsOnUtteranceProgressListener(mTts);
            }
        });
        ...
        for (Locale loc : systemLocales) {
            try {
                ...
                if (retCode >= TextToSpeech.LANG_COUNTRY_AVAILABLE) {
                    ...
                    Timber.v("ReadText.buildAvailableLanguages() :: %s  not available (errorSnackbar code %d)", loc.getDisplayName(), retCode);
                }
