...
public class CollectionHelper {
    ...
    /**
     * Prevents {@link com.ichi2.utils.async.CollectionLoader} from spuriously re-opening the {@link Collection}.
     *
...
//            AnkiDroidApp.sendExceptionReport(e, "CollectionHelper.getColSafe");
     ...
     * default is chosen if the preference hasn't been created yet (i.e., on the first runImport).
     *
