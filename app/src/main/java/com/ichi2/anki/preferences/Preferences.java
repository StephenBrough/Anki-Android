...
public class Preferences extends AppCompatPreferenceActivity implements PreferenceContext, OnSharedPreferenceChangeListener {
    ...
    protected void onPause() {
        ...
        if (!CompatHelper.Companion.isHoneycomb() && getPreferenceScreen() != null) {
            ...
            case "com.ichi2.anki.prefs.reviewing":
                ...
                customButtonsPreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                    public boolean onPreferenceClick(Preference preference) {
                        Intent i = CompatHelper.Companion.getCompat().getPreferenceSubscreenIntent(Preferences.this,
    ...
    /**
     * Code which is runImport when a SharedPreference change has been detected
        ...
        try {
            ...
            switch (key) {
                ...
                case "providerEnabled": {
                    ComponentName providerName = new ComponentName(this, "com.ichi2.anki.other.provider.CardContentProvider");
    ...
    private void removeUnnecessaryAdvancedPrefs(PreferenceScreen screen) {
        ...
        if (!CompatHelper.Companion.hasKanaAndEmojiKeys()) {
        ...
        if (!CompatHelper.Companion.hasScrollKeys() && !CompatHelper.Companion.hasKanaAndEmojiKeys()) {
        ...
        if (workarounds != null) {
            ...
            CompatHelper.Companion.removeHiddenPreferences(this.getApplicationContext());
            if (CompatHelper.Companion.isHoneycomb()) {
                workarounds.removePreference(longclickWorkaround);
            }
            if (CompatHelper.Companion.getSdkVersion() >= 13) {
                workarounds.removePreference(safeDisplayMode);
            }
            if (CompatHelper.Companion.getSdkVersion() >= 15) {
            ...
            if (CompatHelper.Companion.getSdkVersion() >= 16) {
