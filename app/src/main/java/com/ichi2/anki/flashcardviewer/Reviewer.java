...
public class Reviewer extends AbstractFlashcardViewer {
    ...
    protected int getContentViewAttr(int fullscreenMode) {
        if (CompatHelper.Companion.getSdkVersion() < Build.VERSION_CODES.KITKAT) {
    ...
    protected void onCollectionLoaded(Collection col) {
        ...
        if (mPrefFullscreenReview) {
            CompatHelper.Companion.getCompat().setFullScreen(this);
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (!CompatHelper.Companion.isHoneycomb() && !mDisableClipboard) {
        ...
        mWhiteboard.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (!mShowWhiteboard || (mPrefFullscreenReview
                        && CompatHelper.Companion.getCompat().isImmersiveSystemUiVisible(Reviewer.this))) {
