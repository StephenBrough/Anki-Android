...
public class AdvancedStatistics extends Hook  {
     ...
     *
     * A simulation is runImport for each of the specified decks using the settings (max # cards per day, max # reviews per day, initial factor for new cards) for that deck.
     ...
     *
     * A review of a single card is runImport by the specified classifier.
     */
