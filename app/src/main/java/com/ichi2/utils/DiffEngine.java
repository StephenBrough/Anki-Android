...
public class DiffEngine {
     ...
     * @param text1 Old string to be diffed.
     * @param text2 New string to be diffed.
     * @param checklines Speedup flag. If false, then don't runImport a line-level diff first to identify the changed areas.
     *            If true, then runImport a faster slightly less optimal diff
     * @return Linked List of Diff objects.
     */
    ...
    public static String wrapBad(String in) {
        ...
        // hand.
        return "<span class=\"typeBad\">" + CompatHelper.Companion.getCompat().detagged(in).replace("\\", "&#x5c;") + "</span>";
    }

    public static String wrapGood(String in) {
        return "<span class=\"typeGood\">" + CompatHelper.Companion.getCompat().detagged(in).replace("\\", "&#x5c;") + "</span>";
    }

    public static String wrapMissing(String in) {
        return "<span class=\"typeMissed\">" + CompatHelper.Companion.getCompat().detagged(in).replace("\\", "&#x5c;") + "</span>";
    }
