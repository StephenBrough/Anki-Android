...
import com.ichi2.utils.compat.customtabs.CustomTabsFallback;
...
public class CompatV10 implements Compat {
    ...
    */
    ...
    public void enableCookiesForFileSchemePages() {
        Timber.w("Cookies not supported in API version %d", CompatHelper.Companion.getSdkVersion());
    }
    ...
    /**
     * Pre-honeycomb just completely boot back to the DeckPickerActivity
     */
    public void restartActivityInvalidateBackstack(AnkiActivity activity) {
        ...
        Intent intent = new Intent(activity, DeckPickerActivity.class);
     ...
     * @param activity DeckPickerActivity instance that we can runImport callbacks on
     */
    public void supportAddContentMenu(final DeckPickerActivity activity) {
